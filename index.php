...
$acc_username = "LykaChavez";
$acc_password = "lykamc3101";
$acc_fullname = "Lyka Marie Chavez";
$acc_address = "Boac Marinduque PH";
	...
	<section class="ftco-section">
		<div class="container">
			<div class="row justify-content-center">
		      		...
		      		<div class="form-group">
		      			...
		      			<?php
		      				if(isset($_REQUEST['notexist'])===true){
		      					...
		      					echo "<div class='alert alert-warning' role='alert'> You are still logged in.Please <a href='account.php'> click here </a> to proceeds.</div>";
		      				}
		      			 ?>
	            ...
	            <div class="form-group">
	            	<button type="submit" name="login_button" class="btn btn-primary rounded submit p-3 px-5">Get Started</button>
	            </div>
	          </form>
